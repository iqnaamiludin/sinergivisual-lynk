    ...
    <div className="space-y-6 pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-xl font-black text-white">Settings & Konfigurasi</h1>
      ...
      <div className="border-b border-zinc-800 overflow-x-auto scrollbar-none">
      ...
      {activeTab === "account" && (
        <div className="space-y-6 text-xs animate-in fade-in duration-200">
          ...
          <div className="p-6 rounded-3xl bg-gradient-to-r from-emerald-950/90 via-zinc-900 to-zinc-950 border border-emerald-500/40 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xl">
          ...
          {/* Subscription Box */}
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-md">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="text-sm font-bold text-white">Status Langganan Paket:</span>
                <span className="px-2.5 py-0.5 rounded-full bg-emerald-950 text-emerald-400 text-[10px] font-extrabold uppercase border border-emerald-500/30">
                  PRO Studio Active
                </span>
              </div>
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-zinc-950 hover:bg-zinc-800 border border-zinc-700 text-white font-bold text-xs transition shrink-0 cursor-pointer"
            >
              I Want More Benefit
            </button>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
              ...
              <h3 className="text-sm font-bold text-white">Detail Akun Studio</h3>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="flex items-center bg-zinc-950 border border-zinc-700/80 rounded-xl px-3 py-2">
                  <span className="text-zinc-500 font-mono mr-1">lynk.id/</span>
                  <input
                    type="text"
                    value={username}
                    onChange={(e) => setUsername(e.target.value)}
                    className="w-full bg-transparent font-mono font-bold text-emerald-400 focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-700/80 rounded-xl px-3 py-2 text-zinc-300 font-mono focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-700/80 rounded-xl px-3 py-2 text-white font-bold focus:outline-none focus:border-emerald-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-700/80 rounded-xl px-3 py-2 text-white focus:outline-none focus:border-emerald-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-zinc-950 border border-zinc-700/80 rounded-xl p-3 text-white focus:outline-none focus:border-emerald-500 leading-relaxed"
              />
            </div>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
              ...
              <h3 className="text-sm font-bold text-white">Shop Informations (Bio Footer)</h3>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-zinc-950 border border-zinc-800">
                <div>
                  <h4 className="font-bold text-white">Shop Policy</h4>
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl font-bold transition cursor-pointer ${
                    shopPolicy ? "bg-emerald-500 text-zinc-950" : "bg-zinc-800 text-zinc-400"
                  }`}
                >
                  {shopPolicy ? "ON" : "OFF"}
                </button>
              ...
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-zinc-950 border border-zinc-800">
                <div>
                  <h4 className="font-bold text-white">Contact Informations</h4>
                  <p className="text-[11px] text-zinc-400 mt-0.5">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl font-bold transition cursor-pointer ${
                    contactInfo ? "bg-emerald-500 text-zinc-950" : "bg-zinc-800 text-zinc-400"
                  }`}
                >
                  {contactInfo ? "ON" : "OFF"}
                </button>
          ...
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
              ...
              <h3 className="text-sm font-bold text-white">Search Engine Crawl (SEO)</h3>
            </div>

            <div className="flex items-center justify-between p-3.5 rounded-2xl bg-zinc-950 border border-zinc-800">
              <div>
                <h4 className="font-bold text-white">Search Engine Crawl</h4>
                <p className="text-[11px] text-zinc-400 mt-0.5">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl font-bold transition cursor-pointer ${
                  searchEngineCrawl ? "bg-emerald-500 text-zinc-950" : "bg-zinc-800 text-zinc-400"
                }`}
              >
          ...
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-5">
            <div className="flex items-center justify-between pb-2 border-b border-zinc-800">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-white">Floating Contact Platform</h3>
              </div>
              <button
                type="button"
                onClick={() => setFloatingChatIcon(!floatingChatIcon)}
                className={`px-3 py-1.5 rounded-xl font-bold transition cursor-pointer ${
                  floatingChatIcon ? "bg-emerald-500 text-zinc-950" : "bg-zinc-800 text-zinc-400"
                }`}
              >
              ...
              <div className="space-y-4 pt-1">
                    ...
                    <button
                      ...
                      className={`flex-1 py-2.5 px-4 rounded-xl font-bold border transition flex items-center justify-center gap-2 cursor-pointer ${
                        chatPlatform === "telegram"
                          ? "bg-indigo-950/80 border-indigo-500 text-indigo-400 shadow-md shadow-indigo-500/10"
                          : "bg-zinc-950 border-zinc-800 text-zinc-400 hover:text-white"
                      }`}
                    >
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select
                      ...
                      className="bg-zinc-950 border border-zinc-700 rounded-xl px-3 py-2 text-white font-mono focus:outline-none"
                    >
                    ...
                    <input
                      ...
                      className="flex-1 bg-zinc-950 border border-zinc-700 rounded-xl px-3 py-2 text-white font-mono focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-zinc-950 border border-zinc-700 rounded-xl p-3 text-white focus:outline-none focus:border-emerald-500 leading-relaxed"
                  />
                </div>
              </div>
            )}
        ...
        <div className="space-y-6 text-xs animate-in fade-in duration-200">
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
              ...
              <h3 className="text-sm font-bold text-white">Konfigurasi Toko & Faktur</h3>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-700 rounded-xl px-3 py-2 text-white font-mono font-bold focus:outline-none"
                />
              </div>
            </div>
        ...
        <div className="space-y-6 text-xs animate-in fade-in duration-200">
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
              ...
              <h3 className="text-sm font-bold text-white">Rekening Payout & Pencairan Dana</h3>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-700 rounded-xl px-3 py-2 text-white font-mono focus:outline-none focus:border-emerald-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-700 rounded-xl px-3 py-2 text-white uppercase font-bold focus:outline-none focus:border-emerald-500"
                />
              </div>
            </div>
        ...
        <div className="space-y-6 text-xs animate-in fade-in duration-200">
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
              ...
              <h3 className="text-sm font-bold text-white">Custom Domain (CNAME Connection)</h3>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="flex-1 bg-zinc-950 border border-zinc-700 rounded-xl px-3.5 py-2.5 text-white font-mono focus:outline-none focus:border-indigo-500 font-bold"
                />
                <span className="px-3.5 py-2.5 rounded-xl bg-emerald-950 border border-emerald-500/30 text-emerald-400 font-bold flex items-center gap-1.5">
              ...
              <div className="p-3 rounded-xl bg-zinc-950 border border-zinc-800/80 text-[11px] text-zinc-400 space-y-1">
                ...
                <p className="font-mono text-emerald-400 font-bold">
                  Host: <code className="bg-zinc-900 px-1 py-0.5 rounded">lynk</code> &bull; Target: <code className="bg-zinc-900 px-1 py-0.5 rounded">cname.lynk.sinergivisual.com</code>
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-700 rounded-xl px-3 py-2 text-white font-mono focus:outline-none"
                />
              </div>
              <div>
                <label className="block font-semibold text-zinc-300 mb-1">
        ...
        <div className="space-y-6 text-xs animate-in fade-in duration-200">
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
              ...
              <h3 className="text-sm font-bold text-white">Custom Code & Header Injection</h3>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-zinc-950 border border-zinc-700 rounded-xl p-3 text-cyan-400 font-mono focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-zinc-950 border border-zinc-700 rounded-xl p-3 text-emerald-400 font-mono focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
              ...
              <h3 className="text-sm font-bold text-white">Keamanan & Password Protection</h3>
            </div>

            <div className="flex items-center justify-between p-3.5 rounded-2xl bg-zinc-950 border border-zinc-800">
              <div>
                <h4 className="font-bold text-white">Kunci Halaman dengan Password</h4>
                <p className="text-[11px] text-zinc-400 mt-0.5">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl font-bold transition cursor-pointer ${
                  passwordProtection ? "bg-rose-500 text-white" : "bg-zinc-800 text-zinc-400"
                }`}
              >
            ...
            {passwordProtection && (
              <div>
                ...
                <input
                  ...
                  className="w-full max-w-sm bg-zinc-950 border border-zinc-700 rounded-xl px-3 py-2 text-white font-mono focus:outline-none"
                />
              </div>
            )}
          </div>
        ...
        <div className="space-y-6 text-xs animate-in fade-in duration-200">
          <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800 space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
              ...
              <h3 className="text-sm font-bold text-white">Tracking Pixels & Analytics Integration</h3>
            </div>
      ...
      {isInviteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-200">
          <div
            className="relative w-full max-w-md overflow-hidden rounded-3xl bg-zinc-900 border border-zinc-700 p-6 shadow-2xl text-white animate-in zoom-in-95 duration-200"
            ...
            <form onSubmit={handleInviteSubmit} className="mt-4 space-y-4 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-700 rounded-xl px-3 py-2 text-white focus:outline-none focus:border-emerald-500 font-mono"
                />
              </div>
